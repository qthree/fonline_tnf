...
#define PID_FLASH_GRENADE                   (587) // Grouped
	// Other
...
#define PID_NEED_CART_POISON                (907)
#define PID_NEED_CART_NT                    (908)
...
#define ITEM_TREASURE_HOLE 						(900)		//mapgen add
#define ITEM_TREASURE_MAP 							(901)
